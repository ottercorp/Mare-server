...
namespace MareSynchronosServer.Migrations
{
    ...
    [Migration("20250828084634_edit-foreignkey-action")]
    partial class editforeignkeyaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MareSynchronosShared.Models.Auth", b =>
                {
                    ...
                    b.Property<string>("CharaIds")
                        .HasColumnType("jsonb")
                        .HasColumnName("chara_ids");
                    ...
                    b.Property<string>("NameWithWorld")
                        .HasColumnType("text")
                        .HasColumnName("name_with_world");
            ...
            modelBuilder.Entity("MareSynchronosShared.Models.Chat", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("GroupId")
                        .HasDatabaseName("ix_chat_log_group_id");

                    b.HasIndex("SenderId")
                        .HasDatabaseName("ix_chat_log_sender_id");
            ...
            modelBuilder.Entity("MareSynchronosShared.Models.Moodles", b =>
                {
                    ...
                    b.HasIndex("UserUID")
                        .HasDatabaseName("ix_moodles_user_uid");

                    b.ToTable("moodles", (string)null);
                });

            modelBuilder.Entity("MareSynchronosShared.Models.PFinder", b =>
                {
                    ...
                    b.Property<bool>("HasTempGroup")
                        .HasColumnType("boolean")
                        .HasColumnName("has_temp_group");
                    ...
                    b.Property<string>("TempGroupPW")
                        .HasColumnType("text")
                        .HasColumnName("temp_group_pw");
                    ...
                    b.HasIndex("GroupId")
                        .HasDatabaseName("ix_pfinder_group_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_pfinder_user_id");

                    b.ToTable("pfinder", (string)null);
                });

            modelBuilder.Entity("MareSynchronosShared.Models.Support", b =>
                {
                    b.Property<decimal>("DiscordId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(20,0)")
                    ...
                    b.HasIndex("UserUID")
                        .HasDatabaseName("ix_supports_user_uid");
            ...
            modelBuilder.Entity("MareSynchronosShared.Models.Warning", b =>
                {
                    b.Property<decimal>("DiscordId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(20,0)")
            ...
            modelBuilder.Entity("MareSynchronosShared.Models.Chat", b =>
                {
                    b.HasOne("MareSynchronosShared.Models.Group", "Group")
                        ...
                        .HasConstraintName("fk_chat_log_groups_group_id");

                    b.HasOne("MareSynchronosShared.Models.User", "Sender")
                        .WithMany()
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_chat_log_users_sender_id");
            ...
            modelBuilder.Entity("MareSynchronosShared.Models.Moodles", b =>
                {
                    b.HasOne("MareSynchronosShared.Models.User", "User")
                        ...
                        .HasForeignKey("UserUID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_moodles_users_user_uid");
            ...
            modelBuilder.Entity("MareSynchronosShared.Models.PFinder", b =>
                {
                    b.HasOne("MareSynchronosShared.Models.Group", "Group")
                        ...
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_pfinder_groups_group_id");

                    b.HasOne("MareSynchronosShared.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_pfinder_users_user_id");
            ...
            modelBuilder.Entity("MareSynchronosShared.Models.Support", b =>
                {
                    b.HasOne("MareSynchronosShared.Models.User", "User")
                        ...
                        .HasForeignKey("UserUID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_supports_users_user_uid");
